      ...
      <div className="flex flex-row gap-5">
        ...
        <div className="w-[1257px] h-[884px] relative bg-zinc-900 rounded-2xl border border-zinc-700">
          <div className="w-[628px] h-20 left-0 top-0 absolute bg-zinc-900 rounded-tl-2xl border border-zinc-700">
            <div className="left-[30px] top-[23px] absolute text-white text-[28px] font-bold">
              Tissu Tushar
            </div>
          ...
          <div className="w-[631px] h-20 left-[626px] top-0 absolute bg-zinc-900 border border-zinc-700 rounded-tr-lg">
            <div className="left-[30px] top-[15px] absolute text-white text-[24px] font-bold">
              Chat
            </div>
            <div className="left-[33px] top-[44px] absolute text-white text-[16px] font-normal leading-tight">
              You, Tushar, Om, Timeo
            </div>
            ...
            <div className="w-[631px] h-20 left-0 top-[-1px] absolute bg-zinc-900 border rounded-tr-lg border-zinc-700">
              <div className="left-[30px] top-[18px] absolute text-white text-[20px] font-bold">
                Chat
              </div>
              <div className="left-[30px] top-[42px] absolute text-slate-400 text-[16px] font-normal leading-tight">
                You, Tushar & Om
              </div>
            </div>
          </div>
            ...
            <div className="w-[493px] h-[178px] left-[30px] top-[25px] absolute">
              <div className="sap">
                <div className="flex flex-row justify-center items-center gap-5">
                  <input
                    className="bg-[#1E2125] text-white rounded-md p-1 w-48"
                    type="text"
                    value={text}
                    onChange={(e) => setText(e.target.value)}
                  />
                  <button
                    className="text-white p-1 bg-blue-400 rounded-md px-5"
                    onClick={addItem}
                  >
                    Add
                  </button>
