      ...
      <div className="fixed inset-0 z-20 flex items-center justify-center">
        ...
        <div className="bg-[#121517] border border-[#353B43] rounded-lg p-6 z-30 w-[1200px]">
          ...
          <div className="flex justify-center mt-10">
            <input
              className="w-[90%] h-44 bg-[#1E2125] rounded-lg hover:border-gray-300 focus:outline-none focus:shadow-outline focus:border-gray-300 text-white text-center text-xl"
              type="text"
            />
          </div>
